...
MRPCPhysicsList::MRPCPhysicsList() : G4VModularPhysicsList(),
  fEmPhysicsList(0),
  fDecPhysicsList(0),
  fHadronPhys(),    
  fStepMaxProcess(0),
  fMessenger(0)
{
  ...
  fMessenger = new MRPCPhysicsListMessenger(this);
...
MRPCPhysicsList::~MRPCPhysicsList()
{
  delete fMessenger;
...
void MRPCPhysicsList::ConstructParticle()
{
...
void MRPCPhysicsList::ConstructProcess()
{
  // transportation
  //
  AddTransportation();
...
void MRPCPhysicsList::AddPhysicsList(const G4String& name)
{
  if (verboseLevel>0) {
...
void MRPCPhysicsList::AddStepMax()
{
...
void MRPCPhysicsList::AddIonGasModels()
{
...
void MRPCPhysicsList::AddPAIModel(const G4String& modname)
{
  theParticleIterator->reset();
...
void MRPCPhysicsList::NewPAIModel(const G4ParticleDefinition* part, 
			      ...
			      const G4String& procname)
{
  ...
  if(modname == "pai") {
    ...
    fConfig->SetExtraEmModel(partname,procname,pai,"DefaultRegionForTheWorld",
			     0.0,100.*TeV,pai);
